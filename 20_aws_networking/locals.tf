locals {
  ...
  public_instance_type        = var.public_instances_config.instance_type
  public_instance_ebs_size    = var.public_instances_config.ebs_volume.size

  public_asg_name             = join("-", [terraform.workspace, var.public_asg_config.name])
  public_asg_desired_capacity = var.public_asg_config.desired_capacity
  public_asg_max_size         = var.public_asg_config.max_size
  ...
  private_instance_type        = var.private_instances_config.instance_type
  private_instance_ebs_size    = var.private_instances_config.ebs_volume.size

  private_asg_name             = join("-", [terraform.workspace, var.private_asg_config.name])
  private_asg_desired_capacity = var.private_asg_config.desired_capacity
  private_asg_max_size         = var.private_asg_config.max_size
  ...
  nat_instance_type        = var.nat_instances_config.instance_type
